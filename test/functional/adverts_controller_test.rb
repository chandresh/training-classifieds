...
class AdvertsControllerTest < ActionController::TestCase
  ...
  test "should create advert" do
    assert_difference('Advert.count') do
      post :create, advert: { category_id: @advert.category_id, contact_details: @advert.contact_details, description: @advert.description, title: @advert.title }
    end
  ...
  test "should update advert" do
    put :update, id: @advert, advert: { category_id: @advert.category_id, contact_details: @advert.contact_details, description: @advert.description, title: @advert.title }
    assert_redirected_to advert_path(assigns(:advert))
  end
